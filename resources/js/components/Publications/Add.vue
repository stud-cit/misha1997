<template>
    ...
    <div class="container">
        ...
        <step1 v-if="currentStep==2" @getData="getStepData($event)" ></step1>
        <step2  v-if="currentStep==1" @getData="getStepData($event)" @prevStep="prevStep"></step2>
        ...
        <step5  v-if="currentStep==5" @getData="getStepData($event)" @prevStep="prevStep"></step5>
