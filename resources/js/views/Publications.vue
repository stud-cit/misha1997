<template>
  <b-container class="wrapper" id="wrapper">
    <Back page="Всі публікації"></Back>
    <b-row>
        ...
        <b-overlay :show="loading" rounded="sm">
          <div>
            <table>
              ...
              <tr v-for="(item, index) in data" :key="item.id" :class="(item.scopus_id && item.verification == 0) ? 'no-verification' : ''">
                <td>
